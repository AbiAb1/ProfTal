...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['department_id'])) {
    ...
    $type = 'Announcement'; // Assuming the type is always 'Announcement'
    $title = $_POST['title'];
...
// Fetch announcement for display
...
<body>
                    ...
                    <tbody id="announcementTable">
                        <?php foreach ($announcements as $announcement): ?>
                            <tr>
                                ...
                                <td><p><?php echo htmlspecialchars($announcement['taskContent']); ?></p></td>
                                ...
                                <td><?php echo htmlspecialchars(date('M d, Y', strtotime($announcement['DueDate']))); ?></td>
                                <td>
                                    <div class="button-group">
                                        <button class="buttonEdit" 
                                            onclick="editAnnouncement(
                                                ...
                                                '<?php echo htmlspecialchars(addslashes($announcement['taskContent']), ENT_QUOTES); ?>', 
                                                ...
                                                '<?php echo $announcement['DueDate']; ?>'
                                            )">Edit</button>
                                        <button class="buttonDelete" onclick="deleteAnnouncement('<?php echo $announcement['TaskID']; ?>')">Delete</button>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="container">
                        ...
                        <form id="updateForm">
                            ...
                            <button type="button" class="buttonSubmit" onclick = "updateAnnouncement()">Update</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('announcementForm').addEventListener('submit', function(event) {
            ...
            .catch(error => {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'An error occurred while creating the announcment.'
                });
            });
        });
        ...
        function editAnnouncement(taskID, title, content, deptName, gradeTitle, dueDate) {
        ...
        function deleteAnnouncement(task_id) {
            Swal.fire({
                title: 'Are you sure?',

...
if (isset($_POST['task_id'])) {
    ...
    // Prepare and execute SQL query to delete the reminder
    ...
    if ($stmt->execute()) {
        // Return success response
        $response = ['success' => true, 'message' => 'Reminder deleted successfully!'];
    } else {
        // Return error response
...
<body>
    ...
    <script>
        ...
        function editReminder(taskId) {
            // Implement your edit functionality here
        }

        // AJAX request to delete reminder
                ...
                if (result.isConfirmed) {
                    ...
                    .catch(error => {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'An error occurred while deleting the reminder.'
                        });
                    });
                }
            });
